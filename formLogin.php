	...
	<body class="text-center">
		<form class="form-signin" action="#" method="post">
			...
			<label for="inputEmail" class="sr-only">Correo electronico</label>
		  	<input type="email" id="inputEmail" class="form-control" placeholder="Correo electrónico" required autofocus name="username">
		  	...
		  	<button class="btn btn-lg btn-primary btn-block" name="submit" type="submit" value="Ingresar">Ingresar</button>
		  	<a class="btn btn-lg btn-danger btn-block" href="index.php" role="button">Cancelar</a>
